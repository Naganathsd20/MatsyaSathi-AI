      ...
      <div className="flex items-center justify-between pb-3 border-b border-cyan-900/30">
        <div>
          <div className="flex items-center gap-2">
            <h2 className="text-xl font-bold text-white">⛓️ Marine Supply Chain Ecosystem</h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 pt-2">
        {steps.map((st, idx) => (
          <div key={idx} className="p-3.5 rounded-2xl bg-[#0B253C] border border-cyan-900/40 text-center flex flex-col justify-between items-center space-y-2 relative shadow-md">
            <div className="w-6 h-6 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/40 text-xs font-extrabold flex items-center justify-center">
              {st.step}
            </div>
            <div>
