...
import { ShieldAlert, MapPin, Info, AlertTriangle } from 'lucide-react';

export const SafetyHeader = ({ headerData }) => {
  return (
    <div className="space-y-4">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-800/80">
        <div className="flex items-start gap-3.5">
          <div className="p-3 rounded-2xl glass-panel border border-amber-500/30 text-amber-400 shrink-0">
