...
export const SafetyIntegrationCard = () => {
  ...
  return (
    <div className="glass-card rounded-2xl p-5 border border-emerald-500/40 bg-[#0B2A1E]/90 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-md">
      <div className="flex items-start gap-3.5">
        ...
        <div>
          <div className="flex items-center gap-2">
            <h3 className="text-sm font-bold text-white">🛡️ Marine Safety Readiness</h3>
