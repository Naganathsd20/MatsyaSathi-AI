...
import { Settings, MapPin, Info, AlertTriangle } from 'lucide-react';

export const SettingsHeader = ({ headerData }) => {
  return (
    <div className="space-y-4">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-cyan-900/30">
        <div className="flex items-start gap-3.5">
          <div className="p-3 rounded-2xl bg-cyan-500/20 border border-cyan-500/40 text-cyan-400 shadow-md shrink-0">
