...
import { Users, MapPin, Info, AlertTriangle } from 'lucide-react';

export const CommunityHeader = ({ headerData }) => {
  return (
        ...
        <div className="flex items-start gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap mb-1">
              ...
              <span className="inline-flex items-center gap-1 text-xs px-2.5 py-0.5 rounded-full bg-sky-500/10 text-sky-300 border border-sky-500/30 font-semibold">
